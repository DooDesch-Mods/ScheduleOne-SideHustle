...
[assembly: MelonInfo(typeof(SideHustle.Core), "Side Hustle", "1.7.0", "DooDesch", "https://github.com/DooDesch-Mods/ScheduleOne-SideHustle")]
...
namespace SideHustle
{
    ...
    public sealed class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            Log.Msg($"Side Hustle 1.7.0 ready - {API.Registered.Count} gamemode(s) registered so far.");
        }
