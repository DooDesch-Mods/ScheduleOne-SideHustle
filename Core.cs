...
[assembly: MelonInfo(typeof(SideHustle.Core), "Side Hustle", "0.1.0", "DooDesch", null)]
...
namespace SideHustle
{
    ...
    public sealed class Core : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            Log.Msg($"Side Hustle 0.1.0 ready - {API.Registered.Count} gamemode(s) registered so far.");
        }
